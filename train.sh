...
python train.py   --model UNet  --n-epochs 40 --lr 1e-3 --batch-size 4 
python plotting.py --out-file '512' --stage 'test' --name-file '_100_percent_512' --name-model 'UNet' --count 716 --n-epochs  40
